...
const WAYS = [
  {
    ...
    body: "Fuel our projects through financial support, in-kind donations, and collaborative opportunities — putting your name behind clean water and infrastructure that outlasts us.",
